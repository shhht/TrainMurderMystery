...
public class SetResetTemplateAreaCommand {
    public static void register(@NotNull CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(
                CommandManager.literal("tmm:setResetTemplateArea")
                        .requires(source -> source.hasPermissionLevel(2))
                            ...
                            .executes(context -> {
                                AreasWorldComponent.KEY.get(context.getSource().getWorld()).setResetTemplateArea(new Box(
